//Color Grading Shader with LUTs, TheKosmonaut 2018 ( kosmonaut3d@googlemail.com )
...
float4 PSApplyLUT(float4 baseTexture, Texture2D LUT)
{
...
float4 PixelShaderApplyLUT(VertexShaderFSQOutput input) : COLOR0
{
    ...
    // return PSApplyLUT(baseTexture, LUT1);
